              ...
              child: ListView(
                ...
                children: [
                  ...
                  _buildDrawerItem(context, Icons.calendar_month_outlined,
                      'Events', '/events'),
                  _buildDrawerItem(context, Icons.campaign_outlined,
                      'Announcements', '/announcements'),
                  _buildDrawerItem(context, Icons.groups_outlined, 'Ministries',
                      '/ministries'),
                  ...
                  _buildDrawerItem(context, Icons.compare_arrows_outlined,
                      'Transfer', '/church_transfer'),
