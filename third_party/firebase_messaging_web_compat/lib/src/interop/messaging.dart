...
class Messaging extends JsObjectWrapper<messaging_interop.MessagingJsImpl> {
  ...
  static Future<bool> isSupported() =>
      js_util.promiseToFuture<bool>(messaging_interop.isSupported());
  ...
  Future<void> deleteToken() async {
    await js_util.promiseToFuture<bool>(
      messaging_interop.deleteToken(jsObject),
    );
  }
...
class MessagePayload
  ...
  Map<String, dynamic>? get data {
    final data = js_util.dartify(jsObject.data);
    if (data == null) {
      return null;
    }
